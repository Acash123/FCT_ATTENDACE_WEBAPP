...
<html>
<head>
	<title class="um-class">Manage Users</title>
  	<meta charset="utf-8">
  	<meta name="viewport" content="width=device-width, initial-scale=1">
  	<link rel="icon" type="image/png" href="icons/kelaniya.png">
...
<main>
	<h1 class="slideInDown animated" style="color:white;">User Registration,Update and Deregistration </h1>
